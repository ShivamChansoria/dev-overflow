...
const LeftSideBar = async () => {
  ...
  return (
    <section className="custom-scrollbar background-light900_dark200 light-border sticky left-0 top-0 h-scren h-screen flex flex-col justify-between overflow-y-auto border-r p-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]">
        ...
        {userId ? (
          <form action={async () => {
            ...
            <Button type="submit" className="base-medium w-fit !bg-transparent px-4 py-3">
              <LogOut className="max-lg:hidden text-dark300_light900" />
